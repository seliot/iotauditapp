...
export default class CreateObjection extends Component {
    ...
    return (
      <div>
        <section>
          <div class="row">
            <div class="col-lg-6">
              <h4 class="inline">Create Objection</h4>
            </div>
          </div>
          <hr/>
            ...
            <div class="col-lg-12">
              <form>
                <div class="row">
                  ...
                  <div class="col-lg-6 field">
                    <label class="label">Objection Type</label>
                    <p class="">
        ...
        <div class="row bg--clouds no-margin" style="position:fixed;width:100%;bottom:0">
          <div class="col-lg-12">
            ...
            <button class="btn--raised btn--primary m-10-t">Post Objection</button>
          </div>
        </div>
      </div>
    );
